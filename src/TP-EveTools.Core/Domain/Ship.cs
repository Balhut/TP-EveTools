...
namespace TP_EveTools.Core.Domain
{
    public class Ship
    {
        Dictionary<string, string> TypeOfShip = new Dictionary<string, string>{
            {"Molok", "Faction Titan"},
        ...
        Dictionary<string, string> ClassOfShip = new Dictionary<string, string>{
        ...
        public Ship(string name)
        {
            ...
            string cls;
            if (ClassOfShip.TryGetValue(Type, out cls)){
                Class = cls;
            }
            else{
                Class = "Unknown";
